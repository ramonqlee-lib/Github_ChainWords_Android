...
import com.idreems.sdk.protocols.imp.GetWordPicsProtocol;
 ...
 * 
 */
public class GetWordPicsRunner implements Runnable {
	Context context;
	private TaskListener listener;
	private String versionString;
	private String wordString;

	public GetWordPicsRunner(Context context, String version,String word) {
	...
	@Override
	public void run() {
		final GetWordPicsProtocol protocol = new GetWordPicsProtocol(
		...
		agent.getBinary(new TaskListener() {
			...
			public void onSuccess(TaskResponse response) {
				if (response instanceof HttpTaskResponse) {
					...
					GetWordPicsResp ret = (GetWordPicsResp) protocol
