...
public class ChronometerEx extends TextView {
    ...
    public interface OnChronometerTickListener {
         ...
         */
        void onChronometerTick(ChronometerEx chronometer);
    ...
    private ISecondListener secondListener;
    private boolean isShowUp = false;

	public void setShowUp(boolean isShowUp) {
     ...
     * Sets the base to the current time.
     */
    public ChronometerEx(Context context, AttributeSet attrs, int defStyle) {
...
/*
    **
	...
	/**
	 * format time
	 * file:///C:/Users/Max/AppData/Local/Yodao/DeskDict/frame/20140820154219/index.html#
	 * @param timeStr
	 * @return
	 */
...
//        setText(text);
    ...
    private void secondCallBack(long seconds){
    	 if (secondListener != null) {
    		 secondListener.OnSecond(seconds);
         }
    }
    
    public void setSecondListener(ISecondListener secondListener) {
