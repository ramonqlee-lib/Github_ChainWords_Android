...
-(void)setChartMessage:(ChartMessage *)chartMessage
{
    ...
    CGSize contentSize;
    if ([chartMessage.content respondsToSelector:@selector(boundingRectWithSize:options:attributes:context:)]) {
    ...
    {
        contentSize = [chartMessage.content sizeWithFont:[UIFont fontWithName:@"HelveticaNeue" size:13] constrainedToSize:CGSizeMake(200, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
    }
