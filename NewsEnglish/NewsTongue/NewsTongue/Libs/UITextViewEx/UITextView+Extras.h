...
// add color
-(void)addColor:(NSRange)range value:(UIColor*)color clearPrevious:(BOOL)clear;
-(void)setFont:(NSRange)range value:(UIFont*)font clearPrevious:(BOOL)clear;
-(void)setLineSpacing:(CGFloat) lineSpacing clearPrevious:(BOOL)clear;
@end
