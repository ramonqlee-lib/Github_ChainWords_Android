...
static NSString* sLocalRecordFile = @"recorded.mp3";
...
{
    [[AFSoundManager sharedManager]startPlayingLocalFileWithName:sLocalRecordFile andBlock:^(int percentage, CGFloat elapsedTime, CGFloat timeRemaining, NSError *error, BOOL finished) {
