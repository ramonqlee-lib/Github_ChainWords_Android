...
-(void)startPlayingLocalFileWithName:(NSString *)name andBlock:(progressBlock)block
{
    ...
    [self startPlayingLocalFileWithFilePath:filePath andBlock:block];
}

-(void)startPlayingLocalFileWithFilePath:(NSString *)filePath andBlock:(progressBlock)block
{
...
-(void)startRecordingAudioWithFilePath:(NSString *)filePath shouldStopAtSecond:(NSTimeInterval)second {
    _recorder = [[AVAudioRecorder alloc]initWithURL:[NSURL fileURLWithPath:filePath] settings:nil error:nil];
...
-(NSString*)startRecordingAudioWithFileName:(NSString *)name andExtension:(NSString *)extension shouldStopAtSecond:(NSTimeInterval)second {
     NSString* filePath = [NSString stringWithFormat:@"%@/%@.%@", [NSHomeDirectory() stringByAppendingString:@"/Documents"], name, extension];
    [self startRecordingAudioWithFilePath:filePath shouldStopAtSecond:second];
    return filePath;
}
